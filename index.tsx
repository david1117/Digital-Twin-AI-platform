...
const cases: Case[] = [
  {
    ...
    title: 'BMW 智慧工廠元宇宙',
    industry: '製造業',
    image: 'https://blogs.nvidia.com/wp-content/uploads/2022/09/bmw-group-nvidia-omniverse-enterprise-digital-twin-1280x720.jpg',
  ...
  },
  {
    ...
    title: '新加坡城市交通流量即時模擬',
    industry: '智慧城市',
    image: 'https://www.cnet.com/a/img/resize/01d4a75363e7c0507727181c2f219159d3e895cb/hub/2018/03/12/f2a488a0-622f-4091-9447-0e6e76092021/virtual-singapore-3d-model.jpg?auto=webp&fit=crop&height=675&width=1200',
  ...
  },
  {
    ...
    industry: '醫療保健',
    image: 'https://www.3ds.com/sites/default/files/styles/social_media/public/2021-09/3ds-simulia-living-heart-project-social.jpg?itok=zC47f-j0',
  ...
  },
  {
    ...
    title: 'GE 風力發電場運營優化',
    industry: '能源',
    image: 'https://www.ge.com/digital/sites/default/files/styles/hero_desktop/public/2018-01/digital-wind-farm-hero_0.jpg?itok=D7gL9H2L',
  ...
  },
  {
    ...
    title: '大型建築生命週期管理平台',
    industry: '建築',
    image: 'https://images.squarespace-cdn.com/content/v1/5e737523f4636f3224b33532/1628178125010-P4O69Q7LHYYJ5M6T25A0/Digital+Twin+for+Building+Operations.jpg?format=1500w',
  ...
  },
  {
    ...
    industry: '航空航太',
    image: 'https://www.rolls-royce.com/~/media/Images/R/Rolls-Royce/content-images/products/civil/total-care-services-1920x1080.jpg',
  ...
  },
  {
    ...
    industry: '零售與物流',
    image: 'https://customers.microsoft.com/en-us/story/855906-unilever-consumer-goods-azure/media/e1443657-320c-4027-a548-316a928421c6',
  ...
  },
  {
    ...
    title: '鹿特丹港智慧物流',
    industry: '交通與物流',
    image: 'https://www.portofrotterdam.com/sites/default/files/styles/fixed_ratio_16_9_l/public/2022-09/container-wise-dashboard.jpg?itok=L1sM6r-i',
  ...
  },
  {
    ...
    industry: '農業',
    image: 'https://www.deere.com/assets/images/common/our-company/news/2022/january/see-spray-select-r2.jpg',
